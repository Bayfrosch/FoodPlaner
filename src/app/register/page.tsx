    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#1a1a2e] to-[#0a0a0f] flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center w-20 sm:w-24 h-20 sm:h-24 bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 rounded-2xl sm:rounded-3xl mb-6 sm:mb-8 shadow-2xl shadow-purple-500/50 hover:shadow-purple-500/70 transition-shadow">
            <img src="/FoodPlaner.png" alt="FoodPlaner Logo" className="w-14 sm:w-16 h-14 sm:h-16" />
          </div>
          ...
          <p className="text-xs sm:text-lg text-gray-400">Neuer Account erstellen</p>
        </div>
